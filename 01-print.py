...
# program without boilerplate (prepared) code. The simplest directive in Python is the "print" directive -
# it simply prints out a line (and also includes a newline, unlike in C).
#
# There are two major Python versions, Python 2 and Python 3. Python 2 and 3 are quite different. This
...
# statement is not a function, and therefore it is invoked without parentheses. However, in Python 3,
# it is a function, and must be invoked with parentheses.
#
